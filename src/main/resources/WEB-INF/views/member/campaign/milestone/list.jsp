...
<acme:list>
	<acme:list-column code="member.milestone.list.label.title" path="title" width="40%"/>
	<acme:list-column code="member.milestone.list.label.effort" path="effort" width="30%"/>
	<acme:list-column code="member.milestone.list.label.kind" path="kind" width="30%"/>
</acme:list>
