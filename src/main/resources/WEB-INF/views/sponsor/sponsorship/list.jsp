...
<acme:list>
	...
	<acme:list-column code="sponsor.sponsorship.list.label.totalMoney" path="totalMoney" width="20%"/>
	<acme:list-column code="sponsor.sponsorship.list.label.draftMode" path="draftMode" width="25%"/>
