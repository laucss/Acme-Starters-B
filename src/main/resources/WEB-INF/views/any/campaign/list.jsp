...
<acme:list>
	...
	<acme:list-column code="any.campaign.list.label.monthsActive" path="monthsActive" width="20%"/>
	<acme:list-column code="any.campaign.list.label.effort" path="effort" width="20%"/>
