...
<acme:form>
	<acme:form-textbox code="any.fundraiser.form.label.fullName" path="userAccount.identity.fullName"/>
	<acme:form-textbox code="any.fundraiser.form.label.email" path="userAccount.identity.email"/>
