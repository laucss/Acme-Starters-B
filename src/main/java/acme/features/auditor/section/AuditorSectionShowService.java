...
@Service
public class AuditorSectionShowService extends AbstractService<Auditor, Section> {
	...
	public void authorise() {
		...
		status = this.section != null && (this.section.getReport().getAuditor().isPrincipal() || !this.section.getReport().isDraftMode());
